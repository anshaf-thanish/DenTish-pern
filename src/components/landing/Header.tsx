    ...
    <nav className="fixed top-0 right-0 left-0 z-50 px-6 py-2 border-b border-border/50 bg-background/80 backdrop-blur-md h-16">
      <div className="max-w-6xl mx-auto flex justify-between items-center">
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="font-semibold text-lg">DentTish</span>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a href="#PricingSection" className="text-muted-foreground hover:text-foreground">
            Pricing
          </a>
          <a href="#Footer" className="text-muted-foreground hover:text-foreground">
            About
          </a>
        </div>
